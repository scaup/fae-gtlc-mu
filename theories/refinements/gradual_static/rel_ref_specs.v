...
Section relation_for_specification_lemma.
  ...
  Lemma embed_ctx_item_relates (Γ : list stlc_mu.types.type) (e : cast_calculus.lang.expr) (e' : stlc_mu.lang.expr) (τ : stlc_mu.types.type) (pτ : stlc_mu.types.TClosed τ)
      ...
      (map embed_type Γ') ⊨ cast_calculus.contexts.fill_ctx_item (embed_ctx_item C) e ≤log≤ stlc_mu.contexts.fill_ctx_item C e' : (embed_type τ').
  Proof.
    destruct C; intros; inversion H; simplify_eq; simpl.
    - by apply bin_log_related_lam.
  ...
  Lemma embed_ctx_relates (Γ : list stlc_mu.types.type) (e : cast_calculus.lang.expr) (e' : stlc_mu.lang.expr) (τ : stlc_mu.types.type) (pτ : stlc_mu.types.TClosed τ)
        (Γ' : list stlc_mu.types.type) (τ' : stlc_mu.types.type) (C : stlc_mu.contexts.ctx) :
      stlc_mu.contexts.typed_ctx C Γ τ Γ' τ' →
      (map embed_type Γ) ⊨ e ≤log≤ e' : (embed_type τ) →
      (map embed_type Γ') ⊨ cast_calculus.contexts.fill_ctx (embed_ctx C) e ≤log≤ stlc_mu.contexts.fill_ctx C e' : (embed_type τ').
  Proof.
    revert Γ τ pτ Γ' τ' e e'.
    induction C; intros Γ τ pτ Γ' τ' e e' H.
    - by inversion H.
