...
From fae_gtlc_mu Require Import refinements.gradual_static.compat_easy. (* just for notation *)
...
Section adequacy.
  ...
  Proof.
    ...
    { rewrite /Halts_grad in Hsteps. rewrite /cast_calculus.lang.Halts in Hsteps. destruct 1. naive_solver. }
    ...
    - iPoseProof (Hlog ImplΣ SpecΣ [] e' with "[]") as "Hrel".
      ...
      replace e with (e.[cast_calculus.typing.env_subst [] ]) at 2 by by asimpl.
