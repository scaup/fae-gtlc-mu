...
Section logrel.
  ...
  Fixpoint interp_gen (Ψ : typeO -n> D) (τ : typeO) (ww : P) : iPropO Σ := (
    ...
    | TProd τ1 τ2 => ∃ v1v1' v2v2', ⌜ww = (stlc_mu.lang.PairV (v1v1'.1) (v2v2'.1), cast_calculus.lang.PairV (v1v1'.2) (v2v2'.2))⌝ ∧
                                  interp_gen Ψ τ1 v1v1' ∧ interp_gen Ψ τ2 v2v2'
    | TSum τ1 τ2 => (∃ vv', ⌜ww = (stlc_mu.lang.InjLV (vv'.1), InjLV (vv'.2))⌝ ∧ interp_gen Ψ τ1 vv') ∨
  ...
  Lemma interp_rw_TSum τ1 τ2 ww : interp (TSum τ1 τ2) ww ≡
    ((∃ vv', ⌜ww = (stlc_mu.lang.InjLV (vv'.1), InjLV (vv'.2))⌝ ∧ interp τ1 vv') ∨
                    (∃ vv', ⌜ww = (stlc_mu.lang.InjRV (vv'.1), InjRV (vv'.2))⌝ ∧ interp τ2 vv'))%I.
  ...
  Lemma interp_rw_TArrow τ1 τ2 ww : interp (TArrow τ1 τ2) ww ≡
    (□ ∀ vv, interp τ1 vv →
             interp_expr
               (interp τ2) (stlc_mu.lang.App (stlc_mu.lang.of_val (ww.1)) (stlc_mu.lang.of_val (vv.1)),
  ...
  Lemma interp_rw_TRec τb ww : interp (TRec τb) ww ≡
    (□ ∃ w w', ⌜ww = (stlc_mu.lang.FoldV w, cast_calculus.lang.FoldV w')⌝ ∧ ▷ interp (τb.[TRec τb/]) (w, w'))%I.
