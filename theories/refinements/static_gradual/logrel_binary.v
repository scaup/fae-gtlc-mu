...
Section logrel.
  ...
  Typeclasses Opaque interp_rec.

  Arguments interp_rec _ : simpl never.
  ...
  Proof.
    ...
    - rewrite /Persistent interp_unknown_unfold /= intuitionistically_into_persistently.
      by apply persistently_intro'.
  Qed.
  ...
  Proof.
    ...
    - repeat rewrite interp_unknown_unfold'.
      admit.
      (* - unfold interp_expr. *)
