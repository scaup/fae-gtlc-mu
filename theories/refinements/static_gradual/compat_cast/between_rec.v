...
Section between_rec.
  ...
  Proof.
    ...
    iApply (wp_pure_step_later _ _ _ (stlc_mu.lang.Fold ((𝓕c pC (𝓕cV (consTRecTRecExposeCall A τl τr pμτlμτrnotA pC) fs H :: fs)) w)) True); auto. intros _. apply between_TRec_steps.
    (** WP *)
    repeat iModIntro.
    ...
    iApply (wp_wand with "[-]").
    iApply (IHpC ei' (FoldCtx :: K') w w' (𝓕cV (consTRecTRecExposeCall A τl τr pμτlμτrnotA pC) fs H :: fs)). iSplitL "Hfs". iSplitR. simpl. by rewrite H.
