...
Section between_rec.
  ...
  Proof.
    ...
    assert (triv :
              Fix (stlc_mu.lang.Lam (stlc_mu.lang.Lam (stlc_mu.lang.Fold ((𝓕 pC).[upn 1 (ren (+1))].[ren (+1)] (stlc_mu.lang.Unfold (stlc_mu.lang.Var 0)))))).[up (stlc_mu.typing.env_subst fs)].[stlc_mu.lang.of_val $ stlc_mu.lang.FoldV w/] (stlc_mu.lang.Var 0).[up (stlc_mu.typing.env_subst fs)].[stlc_mu.lang.of_val $ stlc_mu.lang.FoldV w/] = Fix (stlc_mu.lang.Lam (stlc_mu.lang.Lam (stlc_mu.lang.Fold ((𝓕 pC).[up (stlc_mu.typing.env_subst fs) >> ren (+1)] (stlc_mu.lang.Unfold (ids 0)))))) (stlc_mu.lang.Fold (w))). by asimpl. rewrite triv. clear triv.
