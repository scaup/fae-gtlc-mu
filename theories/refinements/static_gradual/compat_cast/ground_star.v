...
Section ground_star.
  ...
  Proof.
    ...
    destruct G; rewrite /𝓕c /𝓕.
      + rewrite interp_rw_TUnit. iDestruct "Hvv'" as "%". simpl in H. inversion H. rewrite H0 H1. clear v v' H H0 H1.
        wp_head. asimpl. wp_value.
        iExists (CastV UnitV _ _ (TGround_TUnknown_icp Ground_TUnit)). iSplitL. done.
        rewrite interp_rw_TUnknown. iExists _, _. simpl. iModIntro.
        iLeft. simpl. done. constructor.
      + iDestruct "Hvv'" as ((v1 , v1') (v2 , v2')) "[% [H1 H2]]". simpl in H; inversion H; clear H H1 H2 v v'.
        wp_head. asimpl. wp_value.
        iExists (CastV (PairV v1' v2') _ _ (TGround_TUnknown_icp _ Ground_TProd)). iSplitL. done.
    ...
    CastV (PairV v1' v2') (⋆ × ⋆) ⋆ (TGround_TUnknown_icp (⋆ × ⋆) Ground_TProd))).
        iModIntro. iRight. iLeft.
        iExists v1 , v1' , v2 , v2'. iSplit. done. iSplit; done.
      + wp_head. asimpl. wp_value.
        iExists (CastV v' _ _ (TGround_TUnknown_icp _ Ground_TSum)).
      ...
      + iDestruct "Hvv'" as "#Hvv'". wp_head. asimpl. wp_value.
        iExists (CastV v' _ _ (TGround_TUnknown_icp _ Ground_TArrow)). iSplitL. done.
      ...
      + wp_head. asimpl.
        ...
        iExists (CastV (FoldV u') _ _ (TGround_TUnknown_icp _ Ground_TRec)).
        iSplitL. done.
        rewrite (unfold_fixpoint_interp_unknown1' [] (stlc_mu.lang.FoldV (stlc_mu.lang.InjRV u), CastV (FoldV u') (TRec ⋆) ⋆ (TGround_TUnknown_icp (TRec ⋆) Ground_TRec))).
        iModIntro. iRight. iRight. iRight. iRight.
        iExists u , u'. iSplit; done.
        (* Unshelve. apply (@ectx_lang_ctx stlc_mu.lang.ectx_lang _). *)
  Admitted.
